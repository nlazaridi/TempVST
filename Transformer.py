...
class token_TransformerEncoder(nn.Module):
    def __init__(self, depth, num_heads, embed_dim, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop_rate=0.1, attn_drop_rate=0.1,
...
class Transformer(nn.Module):
    def __init__(self, embed_dim=384, depth=14, num_heads=6, mlp_ratio=3.):
        ...
        self.encoderlayer = TransformerEncoder(embed_dim=embed_dim, depth=depth, num_heads=num_heads, mlp_ratio=mlp_ratio, drop_rate=0.1, attn_drop_rate=0.1,drop_path_rate=0.1)
...
class token_Transformer(nn.Module):
    ...
    def forward(self, rgb_fea):
        ...
        return saliency_fea_1_16, fea_1_16, saliency_tokens
